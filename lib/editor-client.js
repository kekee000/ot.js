...
function EditorClient (revision, clients, serverAdapter, editorAdapter) {
  ...
  this.serverAdapter.registerCallbacks({
    client_join: function (clientId, clientObj) { self.onClientJoin(clientId, clientObj); },
...
EditorClient.prototype.reset = function (revision, clients) {
  this.revision = revision;
  this.setState(new Client.Synchronized());
  this.initializeClients(clients);
};
...
EditorClient.prototype.onClientJoin = function (clientId, clientObj) {
  console.log("User connected: " + clientId);
  this.addClient(clientId, clientObj);
};
